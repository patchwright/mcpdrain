...
# curl | sh — prebuilt binary, no toolchain needed (verifies SHA256)
...
each [release](https://github.com/patchwright/mcpdrain/releases), with a
`SHA256SUMS.txt`. Windows support is planned for a later release.
